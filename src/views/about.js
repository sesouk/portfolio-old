    ...
    <div className='info-container'>
      <div className='conatainer'>
        <h1>My Journey</h1>
          ...
          <p className='p1'> 
            Although my development experience isnt lengthy I spent March 2018 - June 2018 working on several web apps both by myself and with a team. I am proficient in React, Node, Express, and PostgreSQL as the majority of my apps have been built off of those. I have two full scale e-Commerce sites: one for a personal clothing brand that I created and one with a team that was desgined as a one stop shop for all needs. I believe that my experience working with and without a team has made me a better developer because I can develop a web app by myself or I can create code that will function with legacy code. If given the opportunity I believe that I could be an asset to any type of company.
          </p>
